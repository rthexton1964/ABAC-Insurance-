...
def create_insurance_abac_rules():
    ...
    def senior_access(req: AuthorizationRequest) -> bool:
        return (
            ...
            req.action in {"file_claim", "review_claim", "approve_claim", "deny_claim"}
        )
    ...
    def cross_location_deny(req: AuthorizationRequest) -> bool:
        return (
            req.user.attributes.role == 'agent' and
    ...
    def junior_restriction(req: AuthorizationRequest) -> bool:
        return req.user.attributes.level == 'junior' and req.action in {"approve_claim", "deny_claim"}
...
def create_all_rules():
    ...
    return create_insurance_abac_rules()
