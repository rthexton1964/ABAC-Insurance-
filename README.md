# Insurance ABAC Application

Insurance company with fine-grained ABAC authorization

## Features

- Fine-grained ABAC authorization
- Multiple user roles: Agents, Underwriters, Claims Adjusters, Policyholders, Fraud Investigators
- Resource management: Policies, Claims, Underwriting Reports, Fraud Alerts
